...
export const STATE_DATA = [
  {
    ...
    monuments: ["Tirupati Temple", "Charminar (Historical Tie)", "Undavalli Caves", "Golconda Fort", "Lepakshi Temple", "Amaravati Stupa", "Chandragiri Fort"],
  ...
  },
  {
    ...
    monuments: ["Somnath Temple", "Rani ki Vav", "Sun Temple (Modhera)", "Laxmi Vilas Palace", "Dwarkadhish Temple", "Champaner-Pavagadh Park"],
  ...
  },
  {
    ...
    monuments: ["Gateway of India", "Ajanta & Ellora Caves", "Shaniwar Wada", "Raigad Fort", "Elephanta Caves", "Bibi Ka Maqbara", "Chhatrapati Shivaji Terminus"],
  ...
  },
  {
    ...
    monuments: ["Amer Fort", "Mehrangarh Fort", "Hawa Mahal", "Jaisalmer Fort", "City Palace Udaipur", "Kumbhalgarh Fort", "Chittorgarh Fort"],
  ...
  },
  {
    ...
    monuments: ["Taj Mahal", "Agra Fort", "Bara Imambara", "Dhamek Stupa", "Fatehpur Sikri", "Kashi Vishwanath Temple", "Rumi Darwaza"],
